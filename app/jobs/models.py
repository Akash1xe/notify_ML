...
class JobStage(str, Enum):
    ...
    PREPARING_SEMANTIC_INPUT = "PREPARING_SEMANTIC_INPUT"
    BUILDING_VISUAL_CONTEXT = "BUILDING_VISUAL_CONTEXT"
    ANALYZING_VISUAL_CANDIDATES = "ANALYZING_VISUAL_CANDIDATES"
    SELECTING_SEMANTIC_CANDIDATES = "SELECTING_SEMANTIC_CANDIDATES"
    EXTRACTING_SOURCE_SCREENSHOTS = "EXTRACTING_SOURCE_SCREENSHOTS"
    VALIDATING_SCREENSHOT_QUALITY = "VALIDATING_SCREENSHOT_QUALITY"
    GENERATING_VISUAL_FINGERPRINTS = "GENERATING_VISUAL_FINGERPRINTS"
    DETECTING_SCREENSHOT_DUPLICATES = "DETECTING_SCREENSHOT_DUPLICATES"
    SELECTING_FINAL_SCREENSHOTS = "SELECTING_FINAL_SCREENSHOTS"
    PREPARING_DOCUMENT_INPUT = "PREPARING_DOCUMENT_INPUT"
    PLANNING_DOCUMENT_LAYOUT = "PLANNING_DOCUMENT_LAYOUT"
    PREPARING_DOCUMENT_RENDER_PLAN = "PREPARING_DOCUMENT_RENDER_PLAN"
    VALIDATING_DOCUMENT_CACHE = "VALIDATING_DOCUMENT_CACHE"
